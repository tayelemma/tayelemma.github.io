...
function findAllMatchingvalues(json, givenKey) {
    if (Array.isArray(json) || typeof json != 'object')
        return [];
    let matchingKeys = [];
    for (let key in json) {
        ...
        matchingKeys = matchingKeys.concat(findAllMatchingvalues(value, givenKey));
    }
    return matchingKeys;
}
//console.log(findAllMatchingvalues(simpleObject,"a"))
